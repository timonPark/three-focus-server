...
# Codex Skills Project Configuration

> This file governs Codex's behavior when working on the Codex-skills repository.
...
```markdown
[X.Y.Z]: https://github.com/jeffallan/Codex-skills/compare/vPREVIOUS...vX.Y.Z
```
